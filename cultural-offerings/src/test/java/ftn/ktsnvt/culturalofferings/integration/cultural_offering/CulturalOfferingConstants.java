...
public class CulturalOfferingConstants {
    ...
    static final long EXISTING_ENTITY_ID = 11l;
    static final long NON_EXISTING_ENTITY_ID = 525l;
    static final String EXISTING_ENTITY_NAME = "Spomenik kralju Peri";
    static final String NON_EXISTING_ENTITY_NAME = "Spomenik kralju Perici";
    
    static final long EXISTING_ENTITY_TYPE_ID = 10l;
    static final long NON_EXISTING_ENTITY_TYPE_ID = 100l;
    static final long EXISTING_ENTITY_SUBTYPE_ID = 10l;
    static final long NON_EXISTING_ENTITY_SUBTYPE_ID = 100l;
