...
public interface CommentApi {
    ...
    ResponseEntity<CommentDTO> createComment(@RequestBody CommentDTO body);
    ...
    ResponseEntity<CommentDTO> updateComments(@RequestBody CommentDTO body, @PathVariable("id") Long id);
}
